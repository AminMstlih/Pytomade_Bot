...
LEVERAGE = 15
INITIAL_CAPITAL = 10000  # in USDT
RISK_PER_TRADE = 0.1   # 1% of capital per trade
...
def place_order(side, pos_side, size, position_size):
    body = {
        "instId": SYMBOL,
        "tdMode": "cross",
        "side": side,
...
def ml_regime_strategy():
    ...
    while True:
        try:
            ...
            prices = latest_prices[-100:]  # Truncate for consistency
