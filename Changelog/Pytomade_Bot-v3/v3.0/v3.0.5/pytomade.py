...
# OKX API credentials (replace with new ones)
API_KEY = "API_KEY"
...
CONTRACT_SIZE = 10  # 1 contract = 10 DOGE
...
def get_historical_data():
    request_path = f"/api/v5/market/candles?instId={INSTRUMENT}&bar=5m&limit=100"
...
def calculate_indicators(df):
    ...
    def stochastic(high, low, close, k_period=3, d_period=3, smooth_k=5):
